...
Forked from stefanwille/crowd_rails and adapted by Crossroads in order to:
 * run crowd-crossroads
 * soap4r ruby 1.9.2 fork

== INSTALL:

  gem 'soap4r-spox', :git => 'git://github.com/spox/soap4r-spox.git'
...
* gem crowd-crossroads v0.5.12 (or later)
